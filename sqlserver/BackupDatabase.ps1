...
try {
    ...
    $ZipFile = "$BackupPath\$($DatabaseName)_$($Date).zip"
    New-Zipfile -ZipFilePath $ZipFile -InputObject $BackupFile

    Write-Host "INFO: Removing temporary file '$BackupFile'." -BackgroundColor "black" -ForegroundColor "blue"
    Remove-Item $BackupFile

    Write-Host "SUCCESS: Backup file created at '$ZipFile'." -BackgroundColor "black" -ForegroundColor "green"
} catch {
